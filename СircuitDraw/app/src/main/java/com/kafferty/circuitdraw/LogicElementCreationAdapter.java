...
public class LogicElementCreationAdapter {
	...
	List<List<int[]>> realWireCoordinates = new ArrayList<List<int[]>>();
				...
				case MotionEvent.ACTION_UP:
					...
					if (elementToUpdate.hasLogicType())
					{
						...
						if (elementConnectionSuccess) {
							List<int[]> listOfRealCoordinates = new ArrayList<int[]>();
							listOfRealCoordinates.add(initialLineDrawStartCoordinates);
							listOfRealCoordinates.add(connectingCoordinates);
							realWireCoordinates.add(listOfRealCoordinates);
						}
						int[][] point = new int[2][];
